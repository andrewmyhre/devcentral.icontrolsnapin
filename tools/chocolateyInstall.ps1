...
$packageName = 'devcentral.icontrolsnapin' # arbitrary name for the package, used in messages
$installerType = 'MSI' #only one of these: exe, msi, msu
$url = 'https://devcentral.f5.com/labs/PowerShell/iControlSnapInSetup.msi' # download url
$url64 = 'https://devcentral.f5.com/labs/PowerShell/iControlSnapInSetup.msi' # 64bit URL here or remove - if installer decides, then use $url
